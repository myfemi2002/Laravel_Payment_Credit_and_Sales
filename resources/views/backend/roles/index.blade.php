    ...
    <div class="col-sm-12">
        <div class="card">
            <div class="card-header card-buttons">
                <button type="button" class="btn btn-rounded btn-primary mt-1" data-bs-toggle="modal" data-bs-target="#centermodal"  style="float: right;"><i class="fa fa-plus-circle"></i> Add Roles</button>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <button class="btn btn-sm btn-danger" title="Delete Data" id="delete_data" href="{{ route('roles.delete', $item->id) }}">Delete</button>
                                </td>
                            </tr>
                            <!-- Edit Modal -->
                                        ...
                                        <form action="{{ route('roles.update', $item->id) }}" method="POST">
                                            ...
                                            <div class="modal-body">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="Roles Name" name="name" value="{{ $item->name }}">
                                                    @error('name')
            ...
            <div class="modal-body">
                <div class="card w-100">
                    <div class="card-body border-top">
                        <form id="myForm" class="form" method="POST" action="{{ route('roles.store') }}" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-sm-12 col-md-12">
                                    <div class="mb-3 form-group">
                                        <label for="inputfname" class="control-label col-form-label"> Roles Name <span class="text-danger"> *</span></label>
